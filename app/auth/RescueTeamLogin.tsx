...
const LoginScreen = ({ navigation }: any) => {
  ...
  return (
    <View style={styles.container}>
      <Image source={require('../../assets/images/image1.png')} style={styles.logoImage} />
      <Text style={styles.logoText}>ResQ</Text>
      <Text style={styles.loginText}>Rescue Team Login</Text>
      <TextInput
        placeholder="Email"
        value={email}
      ...
      <TouchableOpacity style={styles.googleButton}>
        <Image source={require('../../assets/images/image1.png')} style={styles.googleLogo} />
